  ...
  return (
    <div className="px-5 pb-11 w-full flex flex-col bg-cover bg-light-bg">
      ...
      <div className="relative">
        <img src="scribble.png" alt="scribble" className="h-44 ml-[-8%] mt-[-4%]" />
        <h1 className="absolute inset-0 pl-36 flex items-center font-bold text-5xl text-[#CD49C0] ml-[-3%]">Projects</h1>
      </div>

      {/* Projects */}
      <div className="projects-container" style={{marginTop: "-2rem"}}>
        <div className="tabs-container flex w-full justify-between items-center sm-screen-change">
